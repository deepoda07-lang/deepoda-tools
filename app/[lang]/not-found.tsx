  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none flex items-center justify-center">
        <span className="text-[20rem] font-black text-gray-100 leading-none">
          404
        </span>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 w-full mb-10">
          {POPULAR.map((tool) => (
            <Link
              key={tool.href}
              href={tool.href}
              className="flex items-center gap-2.5 px-4 py-3 rounded-xl border border-gray-200 bg-white hover:border-blue-300 hover:shadow-md hover:shadow-blue-50 text-sm font-medium text-gray-700 hover:text-blue-600 transition-all group"
            >
