...
export default async function Layout({
  ...
  const relatedItems = (RELATED["pdfWatermark"] ?? []).map((k) => ({
    href: TOOL_HREF[k],
    ...
    <div className="max-w-4xl mx-auto px-4 pt-6">
      ...
      {children}
      <RecordVisit href="/pdf/watermark" title={dict.t.pdfWatermark.title} icon={dict.t.pdfWatermark.icon} />
      <ToolSEOSection title={dict.t.pdfWatermark.title} desc={dict.t.pdfWatermark.meta.description} keywords={dict.t.pdfWatermark.meta.keywords} />
      <ToolFAQ items={faq} />
