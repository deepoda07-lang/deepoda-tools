...
export const metadata: Metadata = {
  ...
  description:
    "PDF birleştir, böl, düzenle, filigran ekle, imzala. 6 ücretsiz araç, tarayıcıda çalışır, dosyalar sunucuya gitmez.",
};

const tools = [
  { title: "PDF Birleştir",  description: "Birden fazla PDF'i tek belgede birleştir. Sürükle-bırak ile sırala.",    href: "/pdf/merge",     icon: "📄", badge: "Popüler" },
  { title: "PDF Böl",        description: "PDF sayfalarını ayrı dosyalara böl. Sayfa aralığı seç.",                 href: "/pdf/split",     icon: "✂️" },
  ...
  { title: "PDF İmzala",     description: "İmzanı çiz ve PDF sayfasına göm. Konum ve boyut ayarla.",               href: "/pdf/sign",      icon: "✍️", badge: "Yeni" },
    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-500 max-w-xl">
          PDF dosyalarınızı birleştirin, bölün, düzenleyin. Tüm işlemler tarayıcınızda,
