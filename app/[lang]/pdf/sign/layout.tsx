...
export default async function Layout({
  ...
  const relatedItems = (RELATED["pdfSign"] ?? []).map((k) => ({
    href: TOOL_HREF[k],
    ...
    <div className="max-w-4xl mx-auto px-4 pt-6">
      ...
      {children}
      <RecordVisit href="/pdf/sign" title={dict.t.pdfSign.title} icon={dict.t.pdfSign.icon} />
      <ToolSEOSection title={dict.t.pdfSign.title} desc={dict.t.pdfSign.meta.description} keywords={dict.t.pdfSign.meta.keywords} />
      <ToolFAQ items={faq} />
